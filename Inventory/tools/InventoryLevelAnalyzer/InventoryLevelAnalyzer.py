...
if __name__ == "__main__":
    ...
    for chart_name, chart_data in result["visualizations"].items():
        ...
        with open(f"output/inventory_level_analysis_{chart_name}.png", "wb") as f:
            f.write(base64.b64decode(img_data))
    
    print("Analysis complete. Check the following files:")
    print("- inventory_level_analysis.log (Text Report)")
    print("- output/inventory_analysis_stock_levels.png (Stock Levels by Category)")
    print("- output/inventory_analysis_stockout_risk.png (Stockout Risk by Warehouse)")
    print("- output/inventory_analysis_value_vs_supply.png (Value vs Supply Analysis)")
